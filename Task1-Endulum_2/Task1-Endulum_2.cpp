...
// Task1-Endulum_2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTask1Endulum2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTask1Endulum2App

CTask1Endulum2App::CTask1Endulum2App()
{
...
// Единственный объект CTask1Endulum2App

CTask1Endulum2App theApp;


// Инициализация CTask1Endulum2App

BOOL CTask1Endulum2App::InitInstance()
{
